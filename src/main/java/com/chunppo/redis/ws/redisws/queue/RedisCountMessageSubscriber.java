 ...
 */
@AllArgsConstructor
public class RedisCountMessageSubscriber implements MessageListener {
    ...
    public void onMessage(final Message message, final byte[] pattern) {
        ...
        messagingTemplate.convertAndSend("/topic/count/subscribe", new ChatMessage(RedisCountMessageSubscriber.lastMessage().get()));
    }
