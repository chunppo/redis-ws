package com.chunppo.redis.ws.redisws.config;

import com.chunppo.redis.ws.redisws.queue.*;
...
public class RedisConfig {
    ...
    public JedisConnectionFactory jedisConnectionFactory() {
        return new JedisConnectionFactory(new RedisStandaloneConfiguration("setting redist host", 32768));
    }
